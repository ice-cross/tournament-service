...
import pl.ick.tournament_app.exceptions.QualificationEntryNotFoundException;
import pl.ick.tournament_app.exceptions.QualificationNotFoundException;
...
import pl.ick.tournament_app.repository.QualificationEntryRepository;
...
import pl.ick.tournament_app.utils.mappers.QualificationMapper;
...
public class QualificationService {
    ...
    public QualificationDto getOrCreateQualification(Long tournamentId) {
        ...
        List<Rider> allRiders = riderRepository.findByAgeGroupId(q.getTournament().getAgeGroup().getId());
